...
STATIC_ROOT = os.getenv('STATIC_ROOT', os.path.join(BASE_DIR, 'staticfiles')) ### コード追記
...
INSTALLED_APPS = [
    ...
    'accounts.apps.AccountsConfig', #コード追記（5-6（P.198））
    'book.apps.BookConfig', #コード追記
]
...
MEDIA_URL = '/media/' #コード追記（5-8（P.237））
MEDIA_ROOT = BASE_DIR / 'media' #コード追記（5-8（P.237））
...
##LOGIN_REDIRECT_URL = 'list-book' #コード追記（5-4（P.190））
LOGIN_REDIRECT_URL = 'index' #コード修正（5-6（P.202））
LOGOUT_REDIRECT_URL = 'index' #コード追加（5-6（P.202））
